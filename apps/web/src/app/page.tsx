  ...
  return (
    <main className="flex min-h-svh items-center justify-center p-8">
      <div className="flex max-w-xl flex-col gap-4 text-center">
        <p className="m-0 text-sm font-medium uppercase tracking-widest text-muted-foreground">
        ...
        <div className="mt-2 flex flex-wrap justify-center gap-3">
          {!isLoggedIn && (
            <>
              <Link
                className="inline-flex items-center justify-center rounded-lg px-4 py-2.5 text-base font-medium no-underline transition-colors duration-150 border border-transparent bg-primary text-primary-foreground hover:brightness-105"
                href="/login"
              >
                Entrar
              </Link>
