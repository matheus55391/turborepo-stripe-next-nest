    ...
    <main className="flex min-h-svh items-center justify-center p-8">
      <div className="flex max-w-xl flex-col gap-4 text-center">
        ...
        <div className="mt-2 flex flex-wrap justify-center gap-3">
          ...
          <Link
            className="inline-flex items-center justify-center rounded-lg px-4 py-2.5 text-base font-medium no-underline transition-colors duration-150 border border-dashed border-border bg-transparent text-muted hover:border-solid hover:bg-surface-hover hover:text-foreground"
            href="/dashboard"
          >
            Área logada
          </Link>
